...
# Usage:
#  md_run_multi_cascades_carbon_fixed_and_thermal_bounds.py temperature specie_to_hit cascade_energy cascade_time
#  or call the function:  md_run_multi_cascades_carbon(temperature, specie_to_hit, cascade_energy, cascade_time)
#   where, specie_to_hit can be an atom name, symbol or atomic number.
#   temperature, cascade_energy, cascade_time,  must be positive numbers.
#
#  md_run_multi_cascades_carbon_fixed_and_thermal_bounds.py 100 C_ 1000 4000
#  md_run_multi_cascades_carbon_fixed_and_thermal_bounds.py 900 carbon 1000 4000
#  md_run_multi_cascades_carbon_fixed_and_thermal_bounds.py 900 c 1000 4000
...
def md_run_multi_cascades_carbon_fixed_and_thermal_bounds(temperature,specie_to_hit,cascade_energy,cascade_time):
    
    # ---------------
    # Hard coded options
    fixed_bound_width = 5.0
    thermal_bound_width = 5.0
    # ------------------
...
if __name__ == '__main__':
    ...
    # ensure the cascade energy given is a positive number
    try:
        cascade_energy = float(sys.argv[3])
        if( (cascade_energy < 0) ):
            print("> The cascade energy must be a positive number.")
            print("> Exiting ...")
            sys.exit()
    ...
    md_run_multi_cascades_carbon_fixed_and_thermal_bounds(temperature,specie_to_hit,cascade_energy,cascade_time)
