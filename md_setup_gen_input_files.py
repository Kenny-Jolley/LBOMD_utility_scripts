...
def md_setup_gen_input_files():
    print("  +------------------------------+")
    print("  | Generate generic input files |")
    print("  +------------------------------+\n")
    ...
    outfile.write("12   58    58.0    1.8        /* Ce\n")
    ...
    outfile.write("25   /* Total number of defined interacting-pair types\n")
    ...
    outfile.write("O_   O_    BPUPOTL   /* DELAYE2011_R0   /* FePO4\n")
    outfile.write("Si   Si    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("Si   O_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("Si   B_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("O_   B_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("B_   B_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("He   Si    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("He   O_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("He   B_    BPUPOTL   /* DELAYE2011_R0\n")
    outfile.write("Ag   Ag    ACKLAND\n")
    outfile.write("Ag   Si    BPUPOTL\n")
    outfile.write("Ag   O_    BPUPOTL\n")
    outfile.close()
