...
# Usage:
#  md_run_multi_cascades_carbon.py specie_to_hit cascade_energy cascade_time
#  or call the function:  md_run_multi_cascades_carbon(specie_to_hit, cascade_energy, cascade_time)
#   where, specie_to_hit can be an atom name, symbol or atomic number.
#   cascade_energy, cascade_time,  must be positive numbers.
#
#  md_run_multi_cascades_carbon.py C_ 1000 4000
#  md_run_multi_cascades_carbon.py carbon 1000 4000
#  md_run_multi_cascades_carbon.py c 1000 4000
